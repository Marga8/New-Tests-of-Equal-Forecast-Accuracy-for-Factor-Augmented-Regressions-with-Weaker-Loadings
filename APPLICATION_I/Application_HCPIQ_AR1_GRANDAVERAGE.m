...
XMAT_min_usa=(XMAT_gbr(:,1)+ XMAT_jpn(:,1)+ XMAT_fra(:,1)+ XMAT_deu(:,1)+ ...
                 ...
                 XMAT_irl(:,1)+ XMAT_fin(:,1)+ XMAT_nzl(:,1)+ XMAT_grc(:,1)+ XMAT_prt(:,1)+ ...
                 XMAT_nor(:,1)+ XMAT_kor(:,1)+ XMAT_dnk(:,1)+ XMAT_swe(:,1)+ XMAT_aus(:,1)+ ...
                 XMAT_aut(:,1)+ XMAT_bel(:,1)+ XMAT_che(:,1))/22;
zehat1_usa=recursive_hstep_fast(Y_usa,[XMAT_usa(:,1)],0.25,h);
zehat2_usa=recursive_hstep_fast(Y_usa,[XMAT_usa(:,1),XMAT_min_usa],0.25,h);
...
zehat2_gbr=recursive_hstep_fast(Y_gbr,[XMAT_gbr(:,1),XMAT_min_gbr],0.25,h);
...
zehat2_jpn=recursive_hstep_fast(Y_jpn,[XMAT_jpn(:,1),XMAT_min_jpn],0.25,h);
...
zehat2_fra=recursive_hstep_fast(Y_fra,[XMAT_fra(:,1),XMAT_min_fra],0.25,h);
...
zehat2_deu=recursive_hstep_fast(Y_deu,[XMAT_deu(:,1),XMAT_min_deu],0.25,h);
...
zehat2_esp=recursive_hstep_fast(Y_esp,[XMAT_esp(:,1),XMAT_min_esp],0.25,h);
...
zehat2_ita=recursive_hstep_fast(Y_ita,[XMAT_ita(:,1),XMAT_min_ita],0.25,h);
...
zehat2_nld=recursive_hstep_fast(Y_nld,[XMAT_nld(:,1),XMAT_min_nld],0.25,h);
...
zehat2_lux=recursive_hstep_fast(Y_lux,[XMAT_lux(:,1)+XMAT_min_lux],0.25,h);
...
zehat2_can=recursive_hstep_fast(Y_can,[XMAT_can(:,1)+XMAT_min_can],0.25,h);
...
zehat2_irl=recursive_hstep_fast(Y_irl,[XMAT_irl(:,1)+XMAT_min_irl],0.25,h);
...
zehat2_fin=recursive_hstep_fast(Y_fin,[XMAT_fin(:,1)+XMAT_min_fin],0.25,h);
...
zehat2_nzl=recursive_hstep_fast(Y_nzl,[XMAT_nzl(:,1)+XMAT_min_nzl],0.25,h);
...
zehat2_grc=recursive_hstep_fast(Y_grc,[XMAT_grc(:,1)+XMAT_min_grc],0.25,h);
...
zehat2_prt=recursive_hstep_fast(Y_prt,[XMAT_prt(:,1)+XMAT_min_prt],0.25,h);
...
zehat2_nor=recursive_hstep_fast(Y_nor,[XMAT_nor(:,1)+XMAT_min_nor],0.25,h);
...
zehat2_kor=recursive_hstep_fast(Y_kor,[XMAT_kor(:,1)+XMAT_min_kor],0.25,h);
...
zehat2_dnk=recursive_hstep_fast(Y_dnk,[XMAT_dnk(:,1)+XMAT_min_dnk],0.25,h);
...
zehat2_swe=recursive_hstep_fast(Y_swe,[XMAT_swe(:,1)+XMAT_min_swe],0.25,h);
...
zehat2_aus=recursive_hstep_fast(Y_aus,[XMAT_aus(:,1)+XMAT_min_aus],0.25,h);
...
XMAT_min_aut=(XMAT_usa(:,1)+ XMAT_gbr(:,1)+ XMAT_jpn(:,1)+ XMAT_fra(:,1)+ XMAT_deu(:,1)+ ...
                 ...
                 XMAT_irl(:,1)+ XMAT_fin(:,1)+ XMAT_nzl(:,1)+ XMAT_grc(:,1)+ XMAT_prt(:,1)+ ...
                 XMAT_nor(:,1)+ XMAT_kor(:,1)+ XMAT_dnk(:,1)+ XMAT_swe(:,1)+ XMAT_aus(:,1)+ ...
                 XMAT_bel(:,1)+ XMAT_che(:,1))/22;
zehat1_aut=recursive_hstep_fast(Y_aut,[XMAT_aut(:,1)],0.25,h);
zehat2_aut=recursive_hstep_fast(Y_aut,[XMAT_aut(:,1)+XMAT_min_aut],0.25,h);
...
XMAT_min_bel=(XMAT_usa(:,1)+ XMAT_gbr(:,1)+ XMAT_jpn(:,1)+ XMAT_fra(:,1)+ XMAT_deu(:,1)+ ...
                 ...
                 XMAT_irl(:,1)+ XMAT_fin(:,1)+ XMAT_nzl(:,1)+ XMAT_grc(:,1)+ XMAT_prt(:,1)+ ...
                 XMAT_nor(:,1)+ XMAT_kor(:,1)+ XMAT_dnk(:,1)+ XMAT_swe(:,1)+ XMAT_aus(:,1)+ ...
                 XMAT_aut(:,1)+ XMAT_che(:,1))/22;
zehat1_bel=recursive_hstep_fast(Y_bel,[XMAT_bel(:,1)],0.25,h);
zehat2_bel=recursive_hstep_fast(Y_bel,[XMAT_bel(:,1)+XMAT_min_bel],0.25,h);
...
XMAT_min_che=(XMAT_usa(:,1)+ XMAT_gbr(:,1)+ XMAT_jpn(:,1)+ XMAT_fra(:,1)+ XMAT_deu(:,1)+ ...
                 ...
                 XMAT_irl(:,1)+ XMAT_fin(:,1)+ XMAT_nzl(:,1)+ XMAT_grc(:,1)+ XMAT_prt(:,1)+ ...
                 XMAT_nor(:,1)+ XMAT_kor(:,1)+ XMAT_dnk(:,1)+ XMAT_swe(:,1)+ XMAT_aus(:,1)+ ...
                 XMAT_aut(:,1)+ XMAT_bel(:,1))/22;
zehat1_che=recursive_hstep_fast(Y_che,[XMAT_che(:,1)],0.25,h);
zehat2_che=recursive_hstep_fast(Y_che,[XMAT_che(:,1),XMAT_min_che],0.25,h);
