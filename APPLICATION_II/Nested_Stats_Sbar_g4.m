...
if  lam10<=tau0
    vartau = (((1-tau0)^2)+2*lam10*(1-tau0+log(tau0)))/(lam10*((1-tau0)^2));
elseif lam10>tau0
    vartau = (1-(tau0^2)+2*lam10*((1-tau0)*log(lam10)+tau0*log(tau0)))/(lam10*((1-tau0)^2));
end
...
for l20 = (taua+1):1:n
zvec(l20) = (n/l10)*((sum(ehat1sq(1:l10))/sqrt(n))-(l10/l20)*(sum(ehat2sq(1:l20))/sqrt(n)));
zvec_adj(l20) = (n/l10)*((sum(ehat1sq(1:l10))/sqrt(n))-(l10/l20)*(sum(ehat2sq_adj(1:l20))/sqrt(n)));
end
