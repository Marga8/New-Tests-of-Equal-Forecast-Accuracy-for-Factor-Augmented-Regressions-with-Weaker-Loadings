%R= nr of replications
%N,T, cross section and time dimension
%alpha1=[0.51, 0.7, 1] weak loading parameter, change as needed
...
r = 3; % number of factors in the DGP
lags = 0;
...
% earlier set of lines and un-comment the following two:
