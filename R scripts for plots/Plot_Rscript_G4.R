...
power_values_alpha1_051 <- c(0.098,
                             0.43,
                             0.826,
                             0.912,
                             0.92,
...
power_values_alpha1_01 <- c(0.088,
                            0.372,
                            0.752,
                            0.86,
                            0.874,
...
p <- ggplot(data) +
  ...
  ggtitle(expression("Power Evolution for Different " * alpha[i] * " Values, " * tau[0] * " = 0.8, " * lambda[1]^0 * " = 1")) +  # Add a title with Greek letters
  xlab(expression(" " * beta * " Values")) +                                    # Label the x-axis
  ylab(expression("Power  " * g[4*","*f,]^{adj})) +                             # Label the y-axis
...
p + annotate("text", x = 0.525, y = 0.05, label = "size = 0.088", color = "orange", hjust = 0, size = 5) +  # for alpha = 0.1
  annotate("text", x = 0.525, y = 0.1, label = "size = 0.098", color = "green", hjust = 0, size = 5) +   # for alpha = 0.51
  annotate("text", x = 0.525, y = 0.15, label = "size = 0.092", color = "blue", hjust = 0, size = 5)     # for alpha = 1.00
